...
public class DataAcuityClient {
     ...
     *
     * Runtime override: set system property {@code ro.circleos.dataacuity.pubkey} to override
     * the compile-time default (e.g. via a vendor overlay or device-specific build config).
     */
    private static final String DATA_ACUITY_PUBKEY_B64_DEFAULT =
            "MCowBQYDK2VwAyEA4X1oPgvApdtad/1JbAXJH3yPXbR+QkEwT/50cr4mqbA=";

    private static String getDataAcuityPublicKey() {
        String override = SystemProperties.get("ro.circleos.dataacuity.pubkey", "");
        return override.isEmpty() ? DATA_ACUITY_PUBKEY_B64_DEFAULT : override;
    }
    ...
    private PublicKey loadPublicKey() {
        ...
        try {
            byte[] der = Base64.decode(getDataAcuityPublicKey(), Base64.DEFAULT);
